...
require (
	...
	github.com/go-cinch/common/captcha v1.0.3
	github.com/go-cinch/common/constant v1.0.3
	github.com/go-cinch/common/copierx v1.0.2
	github.com/go-cinch/common/i18n v1.0.3
	github.com/go-cinch/common/id v1.0.3
	github.com/go-cinch/common/idempotent v1.0.3
	github.com/go-cinch/common/jwt v1.0.2
	github.com/go-cinch/common/log v1.0.3
	github.com/go-cinch/common/middleware/i18n v1.0.1
	github.com/go-cinch/common/middleware/tenant v1.0.0
	github.com/go-cinch/common/middleware/trace v1.0.1
	github.com/go-cinch/common/page v1.0.3
	...
	github.com/go-cinch/common/worker v1.0.3
...
require (
	...
	github.com/go-cinch/common/nx v1.0.3 // indirect
