...
require (
	...
	github.com/go-cinch/common/bloom v1.0.2
	github.com/go-cinch/common/captcha v1.0.2
	github.com/go-cinch/common/constant v1.0.1
	github.com/go-cinch/common/copierx v1.0.1
	github.com/go-cinch/common/i18n v1.0.2
	github.com/go-cinch/common/id v1.0.2
	github.com/go-cinch/common/idempotent v1.0.2
	...
	github.com/go-cinch/common/migrate v1.0.2
	github.com/go-cinch/common/page v1.0.2
	github.com/go-cinch/common/plugins/gorm/log v1.0.2
	github.com/go-cinch/common/utils v1.0.2
	github.com/go-cinch/common/worker v1.0.2
