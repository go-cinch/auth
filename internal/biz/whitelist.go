...
func (uc *WhitelistUseCase) find(ctx context.Context, action string, condition *FindWhitelist) (res string, ok bool) {
...
func (uc *WhitelistUseCase) has(ctx context.Context, action string, condition *HasWhitelist) (res string, ok bool) {
	// read data from db and write to cache
